# CVora is a modern, professional CV/Resume builder application that allows users to create beautiful, customizable resumes with multiple templates and export them as PDF files.
